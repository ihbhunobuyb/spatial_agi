...
```bash
# 创建必要的目录
mkdir -p /home/ubuntu/spatial_agi/notebooks
mkdir -p /home/ubuntu/spatial_agi/papers
mkdir -p /home/ubuntu/spatial_agi/daily_thinking
```
...
### 1. 更新论文列表
```bash
# 更新 /home/spatial_agi/papers_list.md
# 添加今日分析的论文
```

### 2. 生成每日思考
```bash
# 创建 /home/ubuntu/spatial_agi/daily_thinking/2026-03-02.md
# 基于所有论文的见解生成深度思考
```
