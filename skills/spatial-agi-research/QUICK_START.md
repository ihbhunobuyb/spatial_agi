...
**使用模板**：
- 模板位置：`/home/ubuntu/spatial_agi/papers/EXAMPLE_full_analysis_template.md`
- 参考这个1542行的完整示例
...
**保存位置**：
```bash
/home/ubuntu/spatial_agi/papers/YYYY-MM-DD_XX_paper_title.md
```
...
- **示例文档**: `/home/ubuntu/spatial_agi/papers/EXAMPLE_full_analysis_template.md`
